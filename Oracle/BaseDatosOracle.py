...
#CREATE USER GONZALO IDENTIFIED BY GONZALO;
#GRANT CONNECT, RESOURCE TO GONZALO;
#ALTER USER GONZALO ACCOUNT UNLOCK;

#Establecer conexión con la base de datos
#dsn = XE o ORCL dependiendo de la version 
cnx = cx_Oracle.connect(user='GONZALO', password='GONZALO', dsn='localhost/xe')


cursor = cnx.cursor()

# Crear tabla Toro
table_toro = '''CREATE TABLE Toro(
    Nombre              VARCHAR2(10),
...
table_ganaderia = '''CREATE TABLE Ganaderia(
    Codigo              NUMBER,
    Nombre              VARCHAR2(10),
...
# Crear tabla Torero
table_torero = '''CREATE TABLE Torero(
    DNI                 NUMBER,
    Nombre              VARCHAR2(10),
    Apodo               VARCHAR2(10),
